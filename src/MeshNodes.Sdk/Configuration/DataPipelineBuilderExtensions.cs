...
public static class DataPipelineBuilderExtensions
{
    ...
    public static IDataPipelineBuilder AddMeshDataPipelineNodes(this IDataPipelineBuilder pipelineBuilder)
    {
        ...
        pipelineBuilder.RegisterNodeConfiguration<BackfillFromRtEntityNodeConfiguration>();
        ...
        pipelineBuilder.RegisterNodeConfiguration<ExportDataPointMappingsNodeConfiguration>();
        pipelineBuilder.RegisterNodeConfiguration<ImportDataPointMappingsNodeConfiguration>();
        ...
        pipelineBuilder.RegisterNodeConfiguration<McpToolCallNodeConfiguration>();
        ...
        pipelineBuilder.RegisterNodeConfiguration<FromMicrosoftGraphEmailNodeConfiguration>();
